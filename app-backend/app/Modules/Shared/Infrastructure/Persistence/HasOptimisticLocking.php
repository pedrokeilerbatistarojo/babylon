...
use App\Shared\Infrastructure\Persistence\Exceptions\StaleModelLockingException;
...
trait HasOptimisticLocking
{
    ...
    protected function applyDelete($forceDelete): void
    {
     ...
     * instance or not.
     */
    public function lockingEnabled(): bool
    {
     ...
     * @return $this
     */
    public function disableLocking(): static
    {
        $this->lock = false;
